...
<body>
    <div class="log-w3">
        <div class="w3layouts-main">
            ...
            <br />
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="please enter email" Display="Dynamic" ControlToValidate="TextBox1"></asp:RequiredFieldValidator>
